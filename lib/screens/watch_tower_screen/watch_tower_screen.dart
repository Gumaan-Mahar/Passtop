...
class WatchTowerScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    watchTowerController.hasPasswordsFetchError.value
        ? EasyLoading.showToast(
            watchTowerController.passwordsFetchErrorMessage.value,
            toastPosition: EasyLoadingToastPosition.top,
            duration: const Duration(
              seconds: 5,
            ),
          )
        : watchTowerController.isRetryingPasswordsFetch.value
            ? EasyLoading.show(
                status: watchTowerController.passwordsFetchErrorMessage.value,
              )
            : null;
    return Scaffold(
                    ...
                    Container(
                      ...
                      child: Obx(
                        () => watchTowerController.isFetching.value
                            ? Shimmer.fromColors(
                                baseColor:
                                    AppColors.customDarkColor.withOpacity(0.5),
